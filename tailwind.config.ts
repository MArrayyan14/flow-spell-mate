  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "check-pop": { "0%": { transform: "scale(0)" }, "60%": { transform: "scale(1.2)" }, "100%": { transform: "scale(1)" } },
        confetti: { "0%": { transform: "translateY(-10vh) rotate(0deg)", opacity: "1" }, "100%": { transform: "translateY(110vh) rotate(720deg)", opacity: "0" } },
      },
      animation: { "accordion-down": "accordion-down 0.2s ease-out", "accordion-up": "accordion-up 0.2s ease-out", float: "float 3s ease-in-out infinite", pop: "pop .24s ease-out", pulseRed: "pulseRed 1.2s ease-in-out infinite", shimmer: "shimmer 1.8s linear infinite", "slide-up": "slide-up .3s ease-out", "check-pop": "check-pop .6s ease-out", confetti: "confetti 3s linear forwards" },
    },
  },
